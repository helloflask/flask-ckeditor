...
latex_documents = [
    (master_doc, 'Flask-CKEditor.tex', u'Flask-CKEditor Documentation',
     u'Grey Li', 'manual'),
]
...
man_pages = [
    (master_doc, 'flask-ckeditor', u'Flask-CKEditor Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'Flask-CKEditor', u'Flask-CKEditor Documentation',
     author, 'Flask-CKEditor', 'One line description of project.',
     'Miscellaneous'),
]
